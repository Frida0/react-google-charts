(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var chartDefaultProps = {
        ...
        getControlWrappers: function (controlWrapperList) { },
        getChartEditor: null,
        className: "",
        style: {},
        formatters: null,
    ...
    var GoogleChart = (function (_super) {
        ...
        GoogleChart.prototype.componentDidMount = function () {
            var _a = this.props, options = _a.options, google = _a.google, chartType = _a.chartType, chartWrapperParams = _a.chartWrapperParams, toolbarItems = _a.toolbarItems, getChartEditor = _a.getChartEditor, getChartWrapper = _a.getChartWrapper, getControlWrappers = _a.getControlWrappers;
            ...
            if (googleChartControls === null) {
                ...
                var controlWrapperList = googleChartControls.map(function (_a) {
                    var control = _a.control;
                    return control;
                });
